import{re}from"./site-k4eckz4x.js";import{$t,Yt,yi}from"./site-c155v2pr.js";import{H}from"./site-n8nnc3kp.js";import{Pi}from"./site-dmcszv7e.js";import{tt,je}from"./site-h10jak1h.js";import{xe,ve}from"./site-t5na8t3j.js";import{oi}from"./site-h8a103rk.js";import{$e}from"./site-hmbgpsad.js";import{wi}from"../hydrate.js";import{i}from"./site-1yf4ncc8.js";var r="furPixelShader",f=`uniform vEyePosition: vec4f;uniform vDiffuseColor: vec4f;uniform furColor: vec4f;uniform furLength: f32;varying vPositionW: vec3f;varying vfur_length: f32;
#ifdef NORMAL
...
`;if(!i.ShadersStoreWGSL[r])i.ShadersStoreWGSL[r]=f;var o=[re,$t,H,Pi,Yt,tt,xe,ve,yi,oi,$e,je,wi];for(let e of o)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var C={name:r,shader:f};export{C as furPixelShaderWGSL};

//# debugId=A6161C1FC33B1A8A64756E2164756E21
//# sourceMappingURL=fur.fragment-stm0jgaz.js.map

import{We,Xe,De,Ie,ze,Ue}from"./site-2h9vrvyz.js";import{_e,ge}from"./site-2pb4jqv9.js";import{H}from"./site-n8nnc3kp.js";import{rt,ct}from"./site-kxgmgds3.js";import{Vi}from"./site-k5mprve9.js";import{Ht,Xt}from"./site-csj5varn.js";import{et}from"./site-k5ekeryj.js";import{li}from"./site-r4v4cv5j.js";import{i}from"./site-1yf4ncc8.js";var r="furVertexShader",t=`attribute position: vec3f;attribute normal: vec3f;
#ifdef UV1
attribute uv: vec2f;
#endif
#ifdef UV2
...
`;if(!i.ShadersStoreWGSL[r])i.ShadersStoreWGSL[r]=t;var n=[We,Xe,De,_e,H,rt,Vi,Ht,Ie,ze,Ue,ge,et,ct,Xt,li];for(let e of n)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var h={name:r,shader:t};export{h as furVertexShaderWGSL};

//# debugId=76C232C36C8F364B64756E2164756E21
//# sourceMappingURL=fur.vertex-nze7xpa9.js.map

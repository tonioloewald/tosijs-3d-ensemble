import{re}from"./site-k4eckz4x.js";import{$t,Yt,yi}from"./site-c155v2pr.js";import{Pi}from"./site-dmcszv7e.js";import{xe,ve}from"./site-t5na8t3j.js";import{H}from"./site-n8nnc3kp.js";import{tt,je}from"./site-h10jak1h.js";import{oi}from"./site-h8a103rk.js";import{$e}from"./site-hmbgpsad.js";import{wi}from"../hydrate.js";import{i}from"./site-1yf4ncc8.js";var o="gradientPixelShader",r=`uniform vEyePosition: vec4f;uniform topColor: vec4f;uniform bottomColor: vec4f;uniform offset: f32;uniform scale: f32;uniform smoothness: f32;varying vPositionW: vec3f;varying vPosition: vec3f;
#ifdef NORMAL
...
`;if(!i.ShadersStoreWGSL[o])i.ShadersStoreWGSL[o]=r;var n=[re,$t,Pi,Yt,xe,H,tt,ve,yi,oi,$e,je,wi];for(let e of n)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var C={name:o,shader:r};export{C as gradientPixelShaderWGSL};

//# debugId=9FE266EF0FB323DE64756E2164756E21
//# sourceMappingURL=gradient.fragment-66s8t3b5.js.map

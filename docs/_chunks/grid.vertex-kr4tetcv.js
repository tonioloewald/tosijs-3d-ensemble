import{De,Ie}from"./site-2h9vrvyz.js";import{xt}from"./site-23zackra.js";import{H}from"./site-n8nnc3kp.js";import{rt,ct}from"./site-kxgmgds3.js";import{_e,ge}from"./site-2pb4jqv9.js";import{et}from"./site-k5ekeryj.js";import{i}from"./site-1yf4ncc8.js";var t="gridVertexShader",r=`attribute position: vec3f;attribute normal: vec3f;
#ifdef UV1
attribute uv: vec2f;
#endif
#ifdef UV2
...
`;if(!i.ShadersStoreWGSL[t])i.ShadersStoreWGSL[t]=r;var n=[De,xt,H,rt,_e,Ie,ct,ge,et];for(let e of n)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var m={name:t,shader:r};export{m as gridVertexShaderWGSL};

//# debugId=9D6242D3704BC30864756E2164756E21
//# sourceMappingURL=grid.vertex-kr4tetcv.js.map

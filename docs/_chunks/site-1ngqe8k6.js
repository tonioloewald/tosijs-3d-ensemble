import{TC as e}from"./site-qntg4d3x.js";var n="openpbrDielectricReflectance",t=`struct ReflectanceParams
...
`;if(!e.IncludesShadersStore[n])e.IncludesShadersStore[n]=t;var m={name:n,shader:t};var i="openpbrGeometryInfo",c=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;if(!e.IncludesShadersStore[i])e.IncludesShadersStore[i]=c;var u={name:i,shader:c};var r="openpbrIblFunctions",f=`#ifdef REFLECTION
...
#endif
`;if(!e.IncludesShadersStore[a])e.IncludesShadersStore[a]=l;var _={name:a,shader:l};
export{m as oj,u as pj,S as qj,F as rj,_ as sj};

//# debugId=53BEEF4D00DD58E664756E2164756E21
//# sourceMappingURL=site-1ngqe8k6.js.map

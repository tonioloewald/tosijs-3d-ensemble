...
#endif
`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=t;var bo={name:a,shader:t};var e="bumpFragmentFunctions",f=`#if defined(BUMP)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=f;var So={name:e,shader:f};var r="bumpFragment",m=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=m;var yo={name:r,shader:m};
export{bo,So,yo};

//# debugId=47DF4FE00D6EACF964756E2164756E21
//# sourceMappingURL=site-1r3cdkxv.js.map

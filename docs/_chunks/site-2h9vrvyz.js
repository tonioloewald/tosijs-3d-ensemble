...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=s;var We={name:e,shader:s};var t="bonesVertex",d=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=d;var ze={name:t,shader:d};var r="bakedVertexAnimationDeclaration",m=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[n])i.IncludesShadersStoreWGSL[n]=o;var De={name:n,shader:o};var a="instancesVertex",u=`#ifdef INSTANCES
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=u;var Ie={name:a,shader:u};var f="bakedVertexAnimation",c=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
export{We,Xe,De,Ie,ze,Ue};

//# debugId=DB74B5C19F82F29164756E2164756E21
//# sourceMappingURL=site-2h9vrvyz.js.map

import{TC as e}from"./site-qntg4d3x.js";var t="pbrFragmentExtraDeclaration",d=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;if(!e.IncludesShadersStoreWGSL[t])e.IncludesShadersStoreWGSL[t]=d;var C={name:t,shader:d};var i="pbrHelperFunctions",u=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;if(!e.IncludesShadersStoreWGSL[i])e.IncludesShadersStoreWGSL[i]=u;var T={name:i,shader:u};var r="pbrDirectLightingSetupFunctions",g=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;if(!e.IncludesShadersStoreWGSL[r])e.IncludesShadersStoreWGSL[r]=g;var G={name:r,shader:g};var o="pbrDirectLightingFalloffFunctions",h=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;if(!e.IncludesShadersStoreWGSL[o])e.IncludesShadersStoreWGSL[o]=h;var F={name:o,shader:h};var f="pbrBlockReflectance0",E=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;if(!e.IncludesShadersStoreWGSL[f])e.IncludesShadersStoreWGSL[f]=E;var y={name:f,shader:E};var n="pbrClusteredLightingFunctions",p=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;if(!e.IncludesShadersStoreWGSL[n])e.IncludesShadersStoreWGSL[n]=p;var x={name:n,shader:p};var a="pbrDirectLightingFunctions",v=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SS_TRANSLUCENCY
...
#endif
`;if(!e.IncludesShadersStoreWGSL[a])e.IncludesShadersStoreWGSL[a]=v;var w={name:a,shader:v};var l="pbrBlockNormalGeometric",L=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;if(!e.IncludesShadersStoreWGSL[l])e.IncludesShadersStoreWGSL[l]=L;var K={name:l,shader:L};var c="pbrBlockImageProcessing",m=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;if(!e.IncludesShadersStoreWGSL[c])e.IncludesShadersStoreWGSL[c]=m;var J={name:c,shader:m};var s="pbrDebug",D=`#if DEBUGMODE>0
...
#endif
`;if(!e.IncludesShadersStoreWGSL[s])e.IncludesShadersStoreWGSL[s]=D;var te={name:s,shader:D};
export{C as Mj,T as Nj,G as Oj,F as Pj,y as Qj,x as Rj,w as Sj,K as Tj,J as Uj,te as Vj};

//# debugId=6C4205A510CC9EBB64756E2164756E21
//# sourceMappingURL=site-310wrqyb.js.map

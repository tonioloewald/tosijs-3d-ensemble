import{kh as r}from"./site-9d6nt8kt.js";import{TC as e}from"./site-qntg4d3x.js";var f="fsr1UpscalePixelShader",a=`#include<ffxFunctions>
...
`;if(!e.ShadersStoreWGSL[f])e.ShadersStoreWGSL[f]=a;var c=[r];for(let l of c)if(!e.IncludesShadersStoreWGSL[l.name])e.IncludesShadersStoreWGSL[l.name]=l.shader;var n={name:f,shader:a};
export{n as hh};

//# debugId=3EF31E3A574081A964756E2164756E21
//# sourceMappingURL=site-3drabj1x.js.map

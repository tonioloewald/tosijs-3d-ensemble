...
#endif
#endif
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=d;var Le={name:e,shader:d};var t="bonesVertex",f=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=f;var Ne={name:t,shader:f};var r="bakedVertexAnimationDeclaration",o=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=o;var ke={name:r,shader:o};var n="instancesDeclaration",s=`#ifdef INSTANCES
...
#endif
#endif
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=s;var Se={name:n,shader:s};var a="instancesVertex",c=`#ifdef INSTANCES
...
#endif
`;if(!i.IncludesShadersStore[m])i.IncludesShadersStore[m]=E;var Ve={name:m,shader:E};
export{Le,ke,Se,be,Ne,Ve};

//# debugId=7D44FE27891FCB3C64756E2164756E21
//# sourceMappingURL=site-4d94fbnh.js.map

...
#endif
#endif
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=h;var Ee={name:e,shader:h};var t="lightUboDeclaration",p=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=p;var Re={name:t,shader:p};var o="shadowsFragmentFunctions",u=`#ifdef SHADOWS
...
#endif
#endif
`;if(!i.IncludesShadersStore[o])i.IncludesShadersStore[o]=u;var Qt={name:o,shader:u};var r="imageProcessingDeclaration",m=`#ifdef EXPOSURE
...
#endif
`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=m;var Yr={name:r,shader:m};var a="imageProcessingFunctions",S=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;if(!i.IncludesShadersStore[a])i.IncludesShadersStore[a]=S;var jr={name:a,shader:S};var s="decalFragmentDeclaration",g=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;if(!i.IncludesShadersStore[s])i.IncludesShadersStore[s]=g;var Sl={name:s,shader:g};var c="prePassDeclaration",x=`#ifdef PREPASS
...
#endif
#endif
`;if(!i.IncludesShadersStore[c])i.IncludesShadersStore[c]=x;var yl={name:c,shader:x};var l="oitDeclaration",w=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;if(!i.IncludesShadersStore[v])i.IncludesShadersStore[v]=D;var no={name:v,shader:D};var d="textureRepetitionFunctions",T=`#if TEXTURE_REPETITION_MODE>0
...
`;if(!i.IncludesShadersStore[d])i.IncludesShadersStore[d]=T;var Cl={name:d,shader:T};var n="depthPrePass",E=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=E;var Ti={name:n,shader:E};var f="oitFragment",C=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
export{Sl,yl,Tl,Ee,Re,no,Qt,Yr,jr,Cl,Ti,El};

//# debugId=8372B6E6AB7FFBF564756E2164756E21
//# sourceMappingURL=site-574dd8qf.js.map

...
#endif
#endif
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=o;var zi={name:e,shader:o};var r="morphTargetsVertexDeclaration",f=`#ifdef MORPHTARGETS
...
#endif
#endif
`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=f;var Ui={name:r,shader:f};var t="morphTargetsVertexGlobal",d=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=d;var Wi={name:t,shader:d};var n="morphTargetsVertex",T=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=T;var Hi={name:n,shader:T};
export{zi,Ui,Wi,Hi};

//# debugId=C3EDEC57D1B8573364756E2164756E21
//# sourceMappingURL=site-77ybpmb8.js.map

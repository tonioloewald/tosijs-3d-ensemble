import{TC as e}from"./site-qntg4d3x.js";var t="clusteredLightingCompute",r=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;if(!e.IncludesShadersStoreWGSL[t])e.IncludesShadersStoreWGSL[t]=r;var a={name:t,shader:r};var i="lightsFragmentFunctions",l=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;if(!e.IncludesShadersStoreWGSL[i])e.IncludesShadersStoreWGSL[i]=l;var u={name:i,shader:l};
export{a as wA,u as xA};

//# debugId=BD2F20C99761FCD364756E2164756E21
//# sourceMappingURL=site-8bd555m7.js.map

import{ih as i}from"./site-zjwsawhd.js";import{RC as e}from"./site-eq33q5cn.js";var f="fsr1SharpenPixelShader",n=`#include<ffxFunctions>
...
`;if(!e.ShadersStoreWGSL[f])e.ShadersStoreWGSL[f]=n;var r=[i];for(let t of r)if(!e.IncludesShadersStoreWGSL[t.name])e.IncludesShadersStoreWGSL[t.name]=t.shader;var x={name:f,shader:n};
export{x as hh};

//# debugId=404DEA29453396F264756E2164756E21
//# sourceMappingURL=site-8shxwgh5.js.map

import{i}from"./site-1yf4ncc8.js";var e="pbrFragmentExtraDeclaration",g=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=g;var ph={name:e,shader:g};var t="subSurfaceScatteringFunctions",h=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=h;var Wa={name:t,shader:h};var r="importanceSampling",p=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=p;var An={name:r,shader:p};var f="pbrHelperFunctions",L=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=L;var mh={name:f,shader:L};var n="pbrDirectLightingSetupFunctions",E=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;if(!i.IncludesShadersStoreWGSL[n])i.IncludesShadersStoreWGSL[n]=E;var _h={name:n,shader:E};var o="pbrDirectLightingFalloffFunctions",m=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;if(!i.IncludesShadersStoreWGSL[o])i.IncludesShadersStoreWGSL[o]=m;var gh={name:o,shader:m};var a="hdrFilteringFunctions",S=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=S;var In={name:a,shader:S};var l="pbrBlockReflectance0",D=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;if(!i.IncludesShadersStoreWGSL[l])i.IncludesShadersStoreWGSL[l]=D;var xh={name:l,shader:D};var c="pbrClusteredLightingFunctions",A=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;if(!i.IncludesShadersStoreWGSL[c])i.IncludesShadersStoreWGSL[c]=A;var vh={name:c,shader:A};var s="pbrDirectLightingFunctions",T=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SS_TRANSLUCENCY
...
#endif
`;if(!i.IncludesShadersStoreWGSL[s])i.IncludesShadersStoreWGSL[s]=T;var bh={name:s,shader:T};var d="pbrBlockNormalGeometric",N=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;if(!i.IncludesShadersStoreWGSL[d])i.IncludesShadersStoreWGSL[d]=N;var Sh={name:d,shader:N};var u="pbrBlockImageProcessing",C=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[u])i.IncludesShadersStoreWGSL[u]=C;var yh={name:u,shader:C};var v="pbrDebug",I=`#if DEBUGMODE>0
...
#endif
`;if(!i.IncludesShadersStoreWGSL[v])i.IncludesShadersStoreWGSL[v]=I;var Th={name:v,shader:I};
export{ph,Wa,An,mh,_h,gh,In,xh,vh,bh,Sh,yh,Th};

//# debugId=3307CEEAF8D6041764756E2164756E21
//# sourceMappingURL=site-a52kk6ts.js.map

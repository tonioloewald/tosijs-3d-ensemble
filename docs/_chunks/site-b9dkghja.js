import{cl,ul,$t,so,dn,Yt,kr,Vr,hl,yi,fl}from"./site-c155v2pr.js";import{xt}from"./site-23zackra.js";import{Fi}from"./site-hnyw7r18.js";import{ah}from"./site-yj7zxvvt.js";import{xs}from"./site-cbrpnk83.js";import{ph,Wa,An,mh,_h,gh,In,xh,vh,bh,Sh,yh,Th}from"./site-a52kk6ts.js";import{To,Ms}from"./site-ge410w5r.js";import{Ya,ja}from"./site-vxkk1bpk.js";import{xe,ve}from"./site-t5na8t3j.js";import{H}from"./site-n8nnc3kp.js";import{tt,je}from"./site-h10jak1h.js";import{re}from"./site-k4eckz4x.js";import{Us}from"./site-kd77xqsc.js";import{Tr}from"./site-0kb0zyma.js";import{Lh,Nh,Fh,Bh,kh}from"./site-gbfzreqs.js";import{$e}from"./site-hmbgpsad.js";import{i}from"./site-1yf4ncc8.js";var r="openpbrFragmentSamplersDeclaration",I=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=C;var P={name:f,shader:C};var s="openpbrNormalMapFragment",G=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;if(!i.IncludesShadersStoreWGSL[s])i.IncludesShadersStoreWGSL[s]=G;var x={name:s,shader:G};var l="openpbrBlockNormalFinal",M=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[m])i.IncludesShadersStoreWGSL[m]=U;var w={name:m,shader:U};var _="openpbrThinFilmLayerData",X=`#ifdef THIN_FILM
...
#endif
`;if(!i.IncludesShadersStoreWGSL[_])i.IncludesShadersStoreWGSL[_]=X;var B={name:_,shader:X};var d="openpbrFuzzLayerData",V=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
`;if(!i.ShadersStoreWGSL[h])i.ShadersStoreWGSL[h]=ne;var fe=[cl,ul,xt,Fi,ah,xs,ph,$t,To,Ya,R,kr,xe,H,tt,hl,re,Wa,An,mh,Vr,Yt,Us,so,_h,gh,Tr,In,dn,xh,vh,bh,ja,N,L,Ms,Lh,F,O,Nh,Fh,P,ve,Sh,x,W,z,kh,Bh,w,B,k,Z,yi,q,Q,ee,ae,$e,je,yh,oe,fl,Th];for(let e of fe)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var Zy={name:h,shader:ne};
export{Zy};

//# debugId=540DA817CBA4023A64756E2164756E21
//# sourceMappingURL=site-b9dkghja.js.map

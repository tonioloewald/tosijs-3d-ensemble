...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=v;var Ht={name:e,shader:v};var t="shadowsVertex",l=`#ifdef SHADOWS
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=l;var Xt={name:t,shader:l};var r="uvAttributeDeclaration",p=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
attribute uv{X}: vec2f;
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=p;var tl={name:r,shader:p};var f="prePassVertexDeclaration",c=`#ifdef PREPASS
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=c;var il={name:f,shader:c};var a="samplerVertexDeclaration",_=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;if(!i.IncludesShadersStoreWGSL[a])i.IncludesShadersStoreWGSL[a]=_;var rl={name:a,shader:_};var n="vertexPullingDeclaration",x=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[n])i.IncludesShadersStoreWGSL[n]=x;var vo={name:n,shader:x};var o="vertexPullingVertex",m=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[o])i.IncludesShadersStoreWGSL[o]=m;var sl={name:o,shader:m};var d="prePassVertex",V=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[d])i.IncludesShadersStoreWGSL[d]=V;var nl={name:d,shader:V};var s="uvVariableDeclaration",E=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[u])i.IncludesShadersStoreWGSL[u]=I;var al={name:u,shader:I};
export{tl,il,rl,Ht,vo,sl,nl,ol,al,Xt};

//# debugId=BD4AF231164C1C4264756E2164756E21
//# sourceMappingURL=site-csj5varn.js.map

...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=d;var qi={name:e,shader:d};var r="morphTargetsVertexDeclaration",a=`#ifdef MORPHTARGETS
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=a;var Zi={name:r,shader:a};var t="morphTargetsVertexGlobal",o=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=o;var ir={name:t,shader:o};var n="morphTargetsVertex",f=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[n])i.IncludesShadersStoreWGSL[n]=f;var rr={name:n,shader:f};
export{qi,Zi,ir,rr};

//# debugId=DFF49B42146A701164756E2164756E21
//# sourceMappingURL=site-d8ramann.js.map

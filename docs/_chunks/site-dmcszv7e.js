import{cl,ul,$t,so,dn,Yt,kr,Vr,hl,yi,fl}from"./site-c155v2pr.js";import{xt}from"./site-23zackra.js";import{Fi}from"./site-hnyw7r18.js";import{cf}from"./site-f6y2z925.js";import{xs}from"./site-cbrpnk83.js";import{re}from"./site-k4eckz4x.js";import{To,Ms}from"./site-ge410w5r.js";import{bo,So,yo}from"./site-1r3cdkxv.js";import{xe,ve}from"./site-t5na8t3j.js";import{H}from"./site-n8nnc3kp.js";import{tt,je}from"./site-h10jak1h.js";import{lf,oi}from"./site-h8a103rk.js";import{$e}from"./site-hmbgpsad.js";import{i}from"./site-1yf4ncc8.js";var r="clusteredLightingCompute",a=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=a;var Sx={name:r,shader:a};var o="lightsFragmentFunctions",n=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;if(!i.IncludesShadersStoreWGSL[o])i.IncludesShadersStoreWGSL[o]=n;var Pi={name:o,shader:n};var t="fresnelFunction",l=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;if(!i.IncludesShadersStoreWGSL[t])i.IncludesShadersStoreWGSL[t]=l;var OT={name:t,shader:l};var f="defaultPixelShader",c=`#include<defaultUboDeclaration>
...
`;if(!i.ShadersStoreWGSL[f])i.ShadersStoreWGSL[f]=c;var s=[xt,Fi,cf,cl,ul,xs,re,$t,so,dn,Sx,Pi,Yt,To,OT,Ms,kr,Vr,hl,bo,So,xe,H,tt,ve,yo,lf,yi,oi,$e,je,fl];for(let e of s)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var MT={name:f,shader:c};
export{Sx,Pi,OT,MT};

//# debugId=F3079E34B508893264756E2164756E21
//# sourceMappingURL=site-dmcszv7e.js.map

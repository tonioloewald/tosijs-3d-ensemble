import{xe,ve}from"./site-t5na8t3j.js";import{bo,So,yo}from"./site-1r3cdkxv.js";import{To,Ms}from"./site-ge410w5r.js";import{re}from"./site-k4eckz4x.js";import{Ya,ja}from"./site-vxkk1bpk.js";import{xt}from"./site-23zackra.js";import{Tr}from"./site-0kb0zyma.js";import{Lh,Nh,Fh,Bh,kh}from"./site-gbfzreqs.js";import{i}from"./site-1yf4ncc8.js";var r="geometryPixelShader",f=`#ifdef BUMP
...
`;if(!i.ShadersStoreWGSL[r])i.ShadersStoreWGSL[r]=f;var n=[xe,bo,To,So,re,Ya,xt,Tr,Lh,ja,Ms,Nh,Fh,ve,yo,Bh,kh];for(let e of n)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var nT={name:r,shader:f};
export{nT};

//# debugId=6AD69C213F82B93D64756E2164756E21
//# sourceMappingURL=site-er8cvwym.js.map

import{TC as e}from"./site-qntg4d3x.js";var t="importanceSampling",a=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
export{l as hj,r as ij};

//# debugId=1ED3C4E0CF31AADA64756E2164756E21
//# sourceMappingURL=site-fre27gc9.js.map

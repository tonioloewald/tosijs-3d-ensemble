...
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=a;var Lh={name:e,shader:a};var r="openpbrGeometryInfo",t=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=t;var Nh={name:r,shader:t};var n="openpbrIblFunctions",c=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;if(!i.IncludesShadersStoreWGSL[f])i.IncludesShadersStoreWGSL[f]=l;var kh={name:f,shader:l};
export{Lh,Nh,Fh,Bh,kh};

//# debugId=68AEFDA9808B0CCB64756E2164756E21
//# sourceMappingURL=site-gbfzreqs.js.map

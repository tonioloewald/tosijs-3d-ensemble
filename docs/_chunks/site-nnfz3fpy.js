import{vj as Ve,wj as ke,xj as Ye,yj as Ze,zj as je}from"./site-qdeapw4x.js";import{Aj as qe}from"./site-8sbrz5mt.js";import{Kj as De,Lj as Ge,Mj as xe,Nj as Me,Oj as ye,Pj as ze,Qj as Ue,Rj as Xe,Sj as He,Tj as Be}from"./site-1f0fqn8e.js";import{Uj as Ce}from"./site-33dzf847.js";import{Vj as Pe,Wj as We}from"./site-g7g0s4nh.js";import{Xj as Oe,Yj as we}from"./site-t356ny5b.js";import{_j as Fe}from"./site-zk35j7k8.js";import{Lk as Ae}from"./site-cr5a6qh0.js";import{BA as de,CA as ue,DA as be,EA as Le}from"./site-x4t1g035.js";import{FA as Ne}from"./site-6b0a8tbg.js";import{GA as Se}from"./site-9etvdk0z.js";import{HA as pe}from"./site-bjjdr5z3.js";import{IA as ge}from"./site-hpk7czd9.js";import{JA as ve}from"./site-rxh8gfe9.js";import{KA as Ee}from"./site-c0mz3g3k.js";import{LA as he}from"./site-fpdx1vc8.js";import{MA as Ie}from"./site-8dvn2q8d.js";import{NA as Re}from"./site-y1qjnjd6.js";import{OA as Te}from"./site-7611pkz2.js";import{QA as me}from"./site-xgvtjbgn.js";import{RA as ce}from"./site-cgmwaca2.js";import{SA as _e}from"./site-tvsjdjzy.js";import{TA as le}from"./site-gsg6fe8a.js";import{UA as se}from"./site-nr8e2t2t.js";import{kB as oe}from"./site-3k38km0y.js";import{lB as fe}from"./site-zxff350y.js";import{mB as ne}from"./site-v9zm9412.js";import{nB as ie}from"./site-yjav6xay.js";import{RC as e}from"./site-eq33q5cn.js";var t="openpbrFragmentSamplersDeclaration",I=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
`;if(!e.IncludesShadersStoreWGSL[f])e.IncludesShadersStoreWGSL[f]=C;var P={name:f,shader:C};var s="openpbrNormalMapFragment",G=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;if(!e.IncludesShadersStoreWGSL[s])e.IncludesShadersStoreWGSL[s]=G;var x={name:s,shader:G};var l="openpbrBlockNormalFinal",M=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;if(!e.IncludesShadersStoreWGSL[E])e.IncludesShadersStoreWGSL[E]=te;var ae={name:E,shader:te};var h="openpbrPixelShader",Ke=`#define OPENPBR_FRAGMENT_SHADER
...
`;if(!e.ShadersStoreWGSL[h])e.ShadersStoreWGSL[h]=Ke;var Qe=[de,ue,se,le,qe,me,De,pe,Ee,Oe,R,Ie,ie,_e,oe,be,ce,Ce,Pe,Ge,Re,Se,Fe,ge,xe,Me,Ae,We,ve,ye,ze,Ue,we,N,L,he,Ve,F,O,ke,Ye,P,ne,Xe,x,W,z,je,Ze,w,H,V,Y,Ne,j,K,J,re,Te,fe,He,ae,Le,Be];for(let r of Qe)if(!e.IncludesShadersStoreWGSL[r.name])e.IncludesShadersStoreWGSL[r.name]=r.shader;var jt={name:h,shader:Ke};
export{jt as uj};

//# debugId=22E1A17565A31E8964756E2164756E21
//# sourceMappingURL=site-nnfz3fpy.js.map

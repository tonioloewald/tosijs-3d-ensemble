...
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=c;var Rn={name:e,shader:c};var n="openpbrDielectricReflectance",f=`struct ReflectanceParams
...
`;if(!i.IncludesShadersStore[n])i.IncludesShadersStore[n]=f;var lh={name:n,shader:f};var r="openpbrGeometryInfo",s=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;if(!i.IncludesShadersStore[r])i.IncludesShadersStore[r]=s;var ch={name:r,shader:s};var o="openpbrIblFunctions",l=`#ifdef REFLECTION
...
#endif
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=m;var fh={name:t,shader:m};
export{Rn,lh,ch,uh,hh,fh};

//# debugId=E98E1CA5E5B45F6D64756E2164756E21
//# sourceMappingURL=site-pyev6w8r.js.map

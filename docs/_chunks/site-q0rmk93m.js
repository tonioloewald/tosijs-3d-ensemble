...
#endif
`;if(!i.IncludesShadersStoreWGSL[d])i.IncludesShadersStoreWGSL[d]=x;var k={name:d,shader:x};var s="pbrBlockClearcoat",X=`struct clearcoatOutParams
...
`;if(!i.ShadersStoreWGSL[O])i.ShadersStoreWGSL[O]=Re;var Ce=[cl,ul,xt,Fi,Ch,xs,ph,$t,To,L,Ya,M,kr,xe,H,tt,hl,re,Wa,An,mh,Vr,Yt,Us,so,_h,gh,Tr,In,dn,xh,vh,bh,ja,bo,So,Ms,lf,F,P,b,G,y,V,k,Y,z,q,ve,Sh,yo,J,yi,j,ie,ne,oe,oi,ce,de,Ee,$e,je,yh,Se,fl,Th];for(let e of Ce)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var tT={name:O,shader:Re};
export{tT};

//# debugId=5141F2718ABAA50664756E2164756E21
//# sourceMappingURL=site-q0rmk93m.js.map

...
#endif
`;if(!i.IncludesShadersStore[_])i.IncludesShadersStore[_]=w;var H={name:_,shader:w};var d="openpbrCoatLayerData",B=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
`;if(!i.ShadersStore[I])i.ShadersStore[I]=fe;var le=[yl,Tl,Rn,Sl,T,St,Ki,dh,vs,Eh,Ee,Re,Io,Xa,b,Yr,Oe,W,it,Cl,ie,Ha,Pn,Rh,jr,Qt,Ws,no,Ah,Ih,yr,On,Ph,$a,F,D,ws,lh,C,M,ch,uh,G,Te,Oh,z,X,H,fh,hh,V,Y,j,K,Ti,J,oe,te,ae,Je,nt,Mh,ce,El,wh];for(let e of le)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var Jy={name:I,shader:fe};
export{Jy};

//# debugId=C473083AF657409364756E2164756E21
//# sourceMappingURL=site-q0zq6ay0.js.map

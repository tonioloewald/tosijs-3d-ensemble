import{Ai as I}from"./site-9t97gg70.js";import{wA as p,xA as g}from"./site-8bd555m7.js";import{zA as h}from"./site-fma21pc5.js";import{IA as E}from"./site-t0fesssv.js";import{JA as v}from"./site-yepct92f.js";import{KA as u}from"./site-b4z1gcca.js";import{LA as S}from"./site-h4f3dppz.js";import{NA as L}from"./site-sk7b30hn.js";import{OA as C}from"./site-87xakm2d.js";import{PA as F}from"./site-pwbh5t5d.js";import{QA as R}from"./site-0ma0ypye.js";import{TA as d}from"./site-nd8mn4f1.js";import{UA as m}from"./site-pxptatb5.js";import{WA as s}from"./site-mevm09sp.js";import{mB as l}from"./site-9kgzghsy.js";import{nB as c}from"./site-qyq8ndc8.js";import{oB as a}from"./site-2e2f7cy5.js";import{pB as t}from"./site-1nhd90ma.js";import{TC as e}from"./site-qntg4d3x.js";var o="intersectionFunctions",f=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;if(!e.IncludesShadersStoreWGSL[o])e.IncludesShadersStoreWGSL[o]=f;var n={name:o,shader:f};var i="backgroundPixelShader",D=`#include<backgroundUboDeclaration>
...
`;if(!e.ShadersStoreWGSL[i])e.ShadersStoreWGSL[i]=D;var O=[s,I,d,L,C,v,u,S,p,g,E,F,m,t,l,n,a,h,R,c];for(let r of O)if(!e.IncludesShadersStoreWGSL[r.name])e.IncludesShadersStoreWGSL[r.name]=r.shader;var K={name:i,shader:D};
export{n as ji,K as ki};

//# debugId=4BBB478A7D487E4764756E2164756E21
//# sourceMappingURL=site-qnjqxydp.js.map

...
#endif
#endif
`;if(!i.IncludesShadersStore[e])i.IncludesShadersStore[e]=n;var ai={name:e,shader:n};var t="clusteredLightingFunctions",f=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;if(!i.IncludesShadersStore[t])i.IncludesShadersStore[t]=f;var Co={name:t,shader:f};var o="decalFragment",d=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;if(!i.IncludesShadersStore[o])i.IncludesShadersStore[o]=d;var hf={name:o,shader:d};
export{Co,hf,ai};

//# debugId=BD902306AF1839E064756E2164756E21
//# sourceMappingURL=site-s7f86j9k.js.map

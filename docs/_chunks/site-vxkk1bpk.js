...
#endif
#endif
`;if(!i.IncludesShadersStoreWGSL[e])i.IncludesShadersStoreWGSL[e]=a;var Ya={name:e,shader:a};var r="pbrIBLFunctions",n=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;if(!i.IncludesShadersStoreWGSL[r])i.IncludesShadersStoreWGSL[r]=n;var ja={name:r,shader:n};
export{Ya,ja};

//# debugId=AEA2A1B5E0324BBD64756E2164756E21
//# sourceMappingURL=site-vxkk1bpk.js.map

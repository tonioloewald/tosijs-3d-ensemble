import{Sl,yl,Tl,Ee,Re,no,Qt,Yr,jr,Cl,Ti,El}from"./site-574dd8qf.js";import{St}from"./site-qq23efnd.js";import{Ki}from"./site-343zg1tr.js";import{Dh}from"./site-h6fckekh.js";import{vs}from"./site-eekksac9.js";import{Eh,Ha,Pn,Rh,Ah,Ih,On,Ph,Oh,Mh,wh}from"./site-xq7m763p.js";import{Io,ws}from"./site-40d55dek.js";import{Xa,$a}from"./site-qw1vg5vg.js";import{Oe,Te}from"./site-rr5ssyqb.js";import{W}from"./site-hsn78nen.js";import{it,nt}from"./site-sjqyzhve.js";import{ie}from"./site-7h7pyq2a.js";import{Ws}from"./site-zvg3r1yw.js";import{yr}from"./site-j3pwthfv.js";import{Eo,Ro,Ao}from"./site-3thdwp0z.js";import{Co,hf,ai}from"./site-s7f86j9k.js";import{Je}from"./site-9xc1h1v8.js";import{i}from"./site-1yf4ncc8.js";var n="pbrFragmentDeclaration",D=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
#endif
`;if(!i.IncludesShadersStore[l])i.IncludesShadersStore[l]=k;var X={name:l,shader:k};var d="pbrBlockReflection",Y=`#ifdef REFLECTION
...
#endif
#endif
`;if(!i.IncludesShadersStore[I])i.IncludesShadersStore[I]=de;var se={name:I,shader:de};var v="pbrBlockReflectance",me=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;if(!i.IncludesShadersStore[v])i.IncludesShadersStore[v]=me;var Ce={name:v,shader:me};var T="pbrBlockDirectLighting",Se=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;if(!i.IncludesShadersStore[T])i.IncludesShadersStore[T]=Se;var ue={name:T,shader:Se};var N="pbrBlockFinalLitComponents",Ae=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;if(!i.IncludesShadersStore[N])i.IncludesShadersStore[N]=Ae;var Ie={name:N,shader:Ae};var p="pbrBlockFinalUnlitComponents",ve=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;if(!i.IncludesShadersStore[p])i.IncludesShadersStore[p]=ve;var Ne={name:p,shader:ve};var O="pbrBlockFinalColorComposition",pe=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;if(!i.IncludesShadersStore[O])i.IncludesShadersStore[O]=pe;var Le={name:O,shader:pe};var L="pbrBlockPrePass",_e=`#if SCENE_MRT_COUNT>0
...
`;if(!i.ShadersStore[_])i.ShadersStore[_]=Me;var Fe=[yl,Tl,Sl,M,St,Ki,Dh,vs,Eh,Ee,Re,Io,h,Xa,P,Yr,Oe,W,it,Cl,ie,Ha,Pn,Rh,jr,Qt,Ws,no,Ah,Ih,yr,On,Ph,$a,Eo,Ro,ws,hf,U,B,V,x,X,w,z,q,j,ee,Co,ae,oe,Te,Oh,Ao,te,Ti,le,se,Ce,ue,ai,Ie,Ne,Le,Je,nt,Mh,De,El,wh];for(let e of Fe)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var rT={name:_,shader:Me};
export{rT};

//# debugId=30180B56F966142364756E2164756E21
//# sourceMappingURL=site-wkpywn3r.js.map

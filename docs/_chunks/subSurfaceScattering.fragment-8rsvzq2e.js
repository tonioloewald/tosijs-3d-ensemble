import{re}from"./site-k4eckz4x.js";import{Wa}from"./site-a52kk6ts.js";import{i}from"./site-1yf4ncc8.js";var r="fibonacci",a=`fn rcp(x: f32)->f32
{return 1./x;}
...
`;if(!i.ShadersStoreWGSL[n])i.ShadersStoreWGSL[n]=s;var c=[re,l,Wa,o];for(let e of c)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var g={name:n,shader:s};export{g as subSurfaceScatteringPixelShaderWGSL};

//# debugId=5A84C7C9B76ABA3164756E2164756E21
//# sourceMappingURL=subSurfaceScattering.fragment-8rsvzq2e.js.map

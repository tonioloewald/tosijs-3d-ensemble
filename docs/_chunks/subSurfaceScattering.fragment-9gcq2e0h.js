import{ie}from"./site-7h7pyq2a.js";import{Ha}from"./site-xq7m763p.js";import{i}from"./site-1yf4ncc8.js";var r="fibonacci",a=`#define rcp(x) 1./x
...
totalWeight=max(totalWeight,HALF_MIN);gl_FragColor=vec4(inputColor.rgb+albedo*max(totalIrradiance/totalWeight,vec3(0.0)),1.);}`;if(!i.ShadersStore[o])i.ShadersStore[o]=f;var s=[ie,n,Ha,c];for(let e of s)if(!i.IncludesShadersStore[e.name])i.IncludesShadersStore[e.name]=e.shader;var g={name:o,shader:f};export{g as subSurfaceScatteringPixelShader};

//# debugId=E06466CD2ACB509C64756E2164756E21
//# sourceMappingURL=subSurfaceScattering.fragment-9gcq2e0h.js.map

import{We,Xe,De,Ie,ze,Ue}from"./site-2h9vrvyz.js";import{_e,ge}from"./site-2pb4jqv9.js";import{rt,ct}from"./site-kxgmgds3.js";import{Vi}from"./site-k5mprve9.js";import{Ht,Xt}from"./site-csj5varn.js";import{H}from"./site-n8nnc3kp.js";import{li}from"./site-r4v4cv5j.js";import{et}from"./site-k5ekeryj.js";import{i}from"./site-1yf4ncc8.js";var r="waterVertexShader",o=`attribute position: vec3f;
#ifdef NORMAL
...
`;if(!i.ShadersStoreWGSL[r])i.ShadersStoreWGSL[r]=o;var n=[We,Xe,De,_e,rt,Vi,Ht,H,Ie,ze,Ue,ge,ct,Xt,li,et];for(let e of n)if(!i.IncludesShadersStoreWGSL[e.name])i.IncludesShadersStoreWGSL[e.name]=e.shader;var g={name:r,shader:o};export{g as waterVertexShaderWGSL};

//# debugId=8DA0A12B832A8F4064756E2164756E21
//# sourceMappingURL=water.vertex-kqn4syqj.js.map
